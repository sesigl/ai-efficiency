...
import { createInventoryItemRepository } from "./infrastructure/di.js";
...
export function createWarehouseUseCases(repository?: InventoryItemRepository): WarehouseUseCases {
  const repo = repository ?? createInventoryItemRepository();
